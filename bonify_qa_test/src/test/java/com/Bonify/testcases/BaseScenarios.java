...
import com.Bonify.pages.BonifyHomePage;
import com.Bonify.pages.BonifyMemberHomePage;
import com.Bonify.pages.BonifyMemberSignUpPage;
import com.Bonify.pages.BonifyMemberSignUpPersonalInfopage;
...
public class BaseScenarios {
	...
	public BonifyHomePage homepage;
	public BonifyMemberSignUpPage memberSignuppage;
	public BonifyMemberSignUpPersonalInfopage memberpersonalInfoPage;
	public BonifyMemberHomePage memberHomePage;
	...
	public void invokeBrowser() {
		...
		try {
			...
			homepage = new BonifyHomePage(driver);			
			memberSignuppage = new BonifyMemberSignUpPage(driver);
			memberpersonalInfoPage= new BonifyMemberSignUpPersonalInfopage(driver);
			memberHomePage= new BonifyMemberHomePage(driver);
